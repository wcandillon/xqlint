...
(:~
 ...
 :
 :)
module namespace mailchimp = "http://www.28msec.com/modules/ws/mailchimp";

import module namespace http-client = "http://expath.org/ns/http-client";

import module namespace xmlrpc = "http://www.28msec.com/modules/xmlrpc";
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-unschedule($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-unschedule($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-schedule($apikey as xs:string, $cid as xs:string, $schedule_time as xs:string, $schedule_time_b as xs:string) as item()* {
...
(:~
 ...
 : @return boolean True on success
 :)
declare %an:sequential function mailchimp:campaign-schedule($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $schedule_time as xs:string, $schedule_time_b as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-resume($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-resume($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-pause($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-pause($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-send-now($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-send-now($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-send-test($apikey as xs:string, $cid as xs:string, $test_emails as element(array), $send_type as xs:string) as item()* {
...
(:~
 ...
 : @return True on success
 :)
declare %an:sequential function mailchimp:campaign-send-test($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $test_emails as element(array), $send_type as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-segment-test($apikey as xs:string, $list_id as xs:string, $options as element(array)) as item()* {
...
(:~
 ...
 : @return The total number of subscribers matching your segmentation options
 :)
declare %an:sequential function mailchimp:campaign-segment-test($endpoint-url as xs:string, $apikey as xs:string, $list_id as xs:string, $options as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-create($apikey as xs:string, $type as xs:string, $options as element(array), $content as element(array), $segment_opts as element(array), $type_opts as element(array)) as item()* {
...
(:~
 ...
 : @return The ID for the created campaign
 :)
declare %an:sequential function mailchimp:campaign-create($endpoint-url as xs:string, $apikey as xs:string, $type as xs:string, $options as element(array), $content as element(array), $segment_opts as element(array), $type_opts as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-update($apikey as xs:string, $cid as xs:string, $name as xs:string, $value as item()) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-update($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $name as xs:string, $value as item()) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-replicate($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return The id of the replicated Campaign created, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:campaign-replicate($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-delete($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return True if the delete succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:campaign-delete($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaigns($apikey as xs:string, $filters as element(array), $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return An array containing a count of all matching campaigns and the specific ones for the current page (see <a href='http://apidocs.mailchimp.com/rtfm/campaigns.func.php'>Mailchimp API documentation</a> for more information about the return type)
 :)
declare %an:sequential function mailchimp:campaigns($endpoint-url as xs:string, $apikey as xs:string, $filters as element(array), $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-stats($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return array struct of the statistics for this campaign
 :)
declare %an:sequential function mailchimp:campaign-stats($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-click-stats($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return URLs will be keys and contain their associated statistics: clicks (number of times a specific link was clicked) and unique (number of unique people who clicked on the specific link).
 :)
declare %an:sequential function mailchimp:campaign-click-stats($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-email-domain-performance($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return Domains email domains and their associated stats
 :)
declare %an:sequential function mailchimp:campaign-email-domain-performance($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-members($apikey as xs:string, $cid as xs:string, $status as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return A total of all matching emails and the specific emails for this page
 :)
declare %an:sequential function mailchimp:campaign-members($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $status as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-hard-bounces($apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return array a total of all hard bounced emails and the specific emails for this page
 :)
declare %an:sequential function mailchimp:campaign-hard-bounces($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-soft-bounces($apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return A total of all soft bounced emails and the specific emails for this page
 :)
declare %an:sequential function mailchimp:campaign-soft-bounces($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-unsubscribes($apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return array email addresses that unsubscribed from this campaign along with reasons, if given array a total of all unsubscribed emails and the specific emails for this page
 :)
declare %an:sequential function mailchimp:campaign-unsubscribes($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-abuse-reports($apikey as xs:string, $cid as xs:string, $since as xs:integer, $start as xs:integer, $limit as xs:string) as item()* {
...
(:~
 ...
 : @return Reports the abuse reports for this campaign
 :)
declare %an:sequential function mailchimp:campaign-abuse-reports($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $since as xs:integer, $start as xs:integer, $limit as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-advice($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return Advice on the campaign's performance
 :)
declare %an:sequential function mailchimp:campaign-advice($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-analytics($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return Analytics we've collected for the passed campaign.
 :)
declare %an:sequential function mailchimp:campaign-analytics($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-geo-opens($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return Countries an array of countries where opens occurred
 :)
declare %an:sequential function mailchimp:campaign-geo-opens($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-geo-opens-for-country($apikey as xs:string, $cid as xs:string, $code as xs:string) as item()* {
...
(:~
 ...
 : @return Regions an array of regions within the provided country where opens occurred.
 :)
declare %an:sequential function mailchimp:campaign-geo-opens-for-country($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $code as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-eep-url-stats($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return Stats an array containing tweets, retweets, clicks, and referrer related to using the campaign's eepurl
 :)
declare %an:sequential function mailchimp:campaign-eep-url-stats($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-bounce-message($apikey as xs:string, $cid as xs:string, $email as xs:string) as item()* {
...
(:~
 ...
 : @return The full bounce message for this email+campaign along with some extra data.
 :)
declare %an:sequential function mailchimp:campaign-bounce-message($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $email as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-bounce-messages($apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer, $since as xs:string) as item()* {
...
(:~
 ...
 : @return Bounces the full bounce messages for this campaign
 :)
declare %an:sequential function mailchimp:campaign-bounce-messages($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer, $since as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-ecomm-orders($apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer, $since as xs:string) as item()* {
...
(:~
 ...
 : @return The total matching orders and the specific orders for the requested page
 :)
declare %an:sequential function mailchimp:campaign-ecomm-orders($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer, $since as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-share-report($apikey as xs:string, $cid as xs:string, $opts as element(array)) as item()* {
...
(:~
 ...
 : @return Struct containing details for the shared report
 :)
declare %an:sequential function mailchimp:campaign-share-report($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $opts as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-content($apikey as xs:string, $cid as xs:string, $for_archive as xs:boolean) as item()* {
...
(:~
 ...
 : @return Struct containing all content for the campaign
 :)
declare %an:sequential function mailchimp:campaign-content($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $for_archive as xs:boolean) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-template-content($apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 : @return Array containing all content section for the campaign -
 :)
declare %an:sequential function mailchimp:campaign-template-content($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-opened-AIM($apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return Array containing the total records matched and the specific records for this page
 :)
declare %an:sequential function mailchimp:campaign-opened-AIM($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return Array containing the total records matched and the specific records for this page
 :)
declare %an:sequential function mailchimp:campaign-not-opened-AIM($apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-not-opened-AIM($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return Array containing the total records matched and the specific records for this page
 :)
declare %an:sequential function mailchimp:campaign-click-detail-AIM($apikey as xs:string, $cid as xs:string, $url as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return Array containing the total records matched and the specific records for this page
 :)
declare %an:sequential function mailchimp:campaign-click-detail-AIM($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $url as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-email-stats-AIM($apikey as xs:string, $cid as xs:string, $email_address as element(array)) as item()* {
...
(:~
 ...
 : @return Array an array with the keys listed in Returned Fields below
 :)
declare %an:sequential function mailchimp:campaign-email-stats-AIM($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $email_address as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-email-stats-AIM-all($apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return Array containing a total record count and data including the actions (opens and clicks) for each email, with timestamps
 :)
declare %an:sequential function mailchimp:campaign-email-stats-AIM-all($endpoint-url as xs:string, $apikey as xs:string, $cid as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaign-ecomm-order-add($apikey as xs:string, $order as element(array)) as item()* {
...
(:~
 ...
 : @return True if the data is saved, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:campaign-ecomm-order-add($endpoint-url as xs:string, $apikey as xs:string, $order as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:lists($apikey as xs:string, $filters as element(array), $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return Array with keys listed in Returned Fields below
 :)
declare %an:sequential function mailchimp:lists($endpoint-url as xs:string, $apikey as xs:string, $filters as element(array), $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-merge-vars($apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 : @return List of merge tags for the list
 :)
declare %an:sequential function mailchimp:list-merge-vars($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-merge-var-add($apikey as xs:string, $id as xs:string, $tag as xs:string, $name as xs:string, $options as element(array)) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-merge-var-add($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $tag as xs:string, $name as xs:string, $options as element(array)) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-merge-var-update($apikey as xs:string, $id as xs:string, $tag as xs:string, $options as element(array)) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-merge-var-update($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $tag as xs:string, $options as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-merge-var-del($apikey as xs:string, $id as xs:string, $tag as xs:string) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-merge-var-del($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $tag as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-interest-groupings($apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 : @return List of interest groups for the list
 :)
declare %an:sequential function mailchimp:list-interest-groupings($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-group-add($apikey as xs:string, $id as xs:string, $group_name as xs:string, $grouping_id as xs:integer) as item()* {
...
(:~
 ...
 : @return bool true if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-group-add($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $group_name as xs:string, $grouping_id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-group-del($apikey as xs:string, $id as xs:string, $group_name as xs:string, $grouping_id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-group-del($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $group_name as xs:string, $grouping_id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-group-update($apikey as xs:string, $id as xs:string, $old_name as xs:string, $new_name as xs:string, $grouping_id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-group-update($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $old_name as xs:string, $new_name as xs:string, $grouping_id as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-interest-grouping-add($apikey as xs:string, $id as xs:string, $name as xs:string, $type as xs:string, $groups as element(array)) as item()* {
...
(:~
 ...
 : @return The new grouping id if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-grouping-add($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $name as xs:string, $type as xs:string, $groups as element(array)) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-grouping-update($apikey as xs:string, $grouping_id as xs:integer, $name as xs:string, $value as xs:string) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-grouping-update($endpoint-url as xs:string, $apikey as xs:string, $grouping_id as xs:integer, $name as xs:string, $value as xs:string) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-grouping-del($apikey as xs:string, $grouping_id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if the request succeeds, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:list-interest-grouping-del($endpoint-url as xs:string, $apikey as xs:string, $grouping_id as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-webhooks($apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 : @return List of webhooks
 :)
declare %an:sequential function mailchimp:list-webhooks($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-webhook-add($apikey as xs:string, $id as xs:string, $url as xs:string, $actions as element(array), $sources as element(array)) as item()* {
...
(:~
 ...
 : @return True if the call succeeds, otherwise an exception will be thrown
 :)
declare %an:sequential function mailchimp:list-webhook-add($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $url as xs:string, $actions as element(array), $sources as element(array)) as item()* {
...
(:~
 ...
 : @return True if the call succeeds, otherwise an exception will be thrown
 :)
declare %an:sequential function mailchimp:list-webhook-del($apikey as xs:string, $id as xs:string, $url as xs:string) as item()* {
...
(:~
 ...
 : @return True if the call succeeds, otherwise an exception will be thrown
 :)
declare %an:sequential function mailchimp:list-webhook-del($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $url as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-static-segments($apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 : @return An array of parameters for each static segment
 :)
declare %an:sequential function mailchimp:list-static-segments($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-static-segment-add($apikey as xs:string, $id as xs:string, $name as xs:string) as item()* {
...
(:~
 ...
 : @return The id of the new segment, otherwise an error will be thrown.
 :)
declare %an:sequential function mailchimp:list-static-segment-add($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $name as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-static-segment-reset($apikey as xs:string, $id as xs:string, $seg_id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if it worked, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:list-static-segment-reset($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $seg_id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if it worked, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:list-static-segment-del($apikey as xs:string, $id as xs:string, $seg_id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if it worked, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:list-static-segment-del($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $seg_id as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-static-segment-members-add($apikey as xs:string, $id as xs:string, $seg_id as xs:integer, $batch as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-static-segment-members-add($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $seg_id as xs:integer, $batch as element(array)) as item()* {
...
(:~
 ...
 : @return An array with the results of the operation
 :)
declare %an:sequential function mailchimp:list-static-segment-members-del($apikey as xs:string, $id as xs:string, $seg_id as xs:integer, $batch as element(array)) as item()* {
...
(:~
 ...
 : @return An array with the results of the operation
 :)
declare %an:sequential function mailchimp:list-static-segment-members-del($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $seg_id as xs:integer, $batch as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-subscribe($apikey as xs:string, $id as xs:string, $email_address as xs:string, $merge_vars as element(array), $email_type as xs:string, $double_optin as xs:boolean, $update_existing as xs:boolean, $replace_interests as xs:boolean, $send_welcome as xs:boolean) as item()* {
...
(:~
 ...
 : @return True on success, false on failure.
 :)
declare %an:sequential function mailchimp:list-subscribe($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $email_address as xs:string, $merge_vars as element(array), $email_type as xs:string, $double_optin as xs:boolean, $update_existing as xs:boolean, $replace_interests as xs:boolean, $send_welcome as xs:boolean) as item()* {
...
(:~
 ...
 : @return True on success, false on failure.
 :)
declare %an:sequential function mailchimp:list-unsubscribe($apikey as xs:string, $id as xs:string, $email_address as xs:string, $delete_member as xs:boolean, $send_goodbye as xs:boolean, $send_notify as xs:boolean) as item()* {
...
(:~
 ...
 : @return True on success, false on failure.
 :)
declare %an:sequential function mailchimp:list-unsubscribe($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $email_address as xs:string, $delete_member as xs:boolean, $send_goodbye as xs:boolean, $send_notify as xs:boolean) as item()* {
...
(:~
 ...
 : @return True on success, false on failure.
 :)
declare %an:sequential function mailchimp:list-update-member($apikey as xs:string, $id as xs:string, $email_address as xs:string, $merge_vars as element(array), $email_type as xs:string, $replace_interests as xs:boolean) as item()* {
...
(:~
 ...
 : @return True on success, false on failure.
 :)
declare %an:sequential function mailchimp:list-update-member($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $email_address as xs:string, $merge_vars as element(array), $email_type as xs:string, $replace_interests as xs:boolean) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-batch-subscribe($apikey as xs:string, $id as xs:string, $batch as element(array), $double_optin as xs:boolean, $update_existing as xs:boolean, $replace_interests as xs:boolean) as item()* {
...
(:~
 ...
 : @return Array of result counts and any errors that occurred
 :)
declare %an:sequential function mailchimp:list-batch-subscribe($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $batch as element(array), $double_optin as xs:boolean, $update_existing as xs:boolean, $replace_interests as xs:boolean) as item()* {
...
(:~
 ...
 : @return Array of result counts and any errors that occurred
 :)
declare %an:sequential function mailchimp:list-batch-unsubscribe($apikey as xs:string, $id as xs:string, $emails as element(array), $delete_member as xs:boolean, $send_goodbye as xs:boolean, $send_notify as xs:boolean) as item()* {
...
(:~
 ...
 : @return Array of result counts and any errors that occurred
 :)
declare %an:sequential function mailchimp:list-batch-unsubscribe($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $emails as element(array), $delete_member as xs:boolean, $send_goodbye as xs:boolean, $send_notify as xs:boolean) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-members($apikey as xs:string, $id as xs:string, $status as xs:string, $since as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 : @return Array of a the total records match and matching list member data for this page (see Returned Fields for details)
 :)
declare %an:sequential function mailchimp:list-members($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $status as xs:string, $since as xs:string, $start as xs:integer, $limit as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-member-info($apikey as xs:string, $id as xs:string, $email_address as element(array)) as item()* {
...
(:~
 ...
 : @return Array of list members with their info in an array (see Returned Fields for details)
 :)
declare %an:sequential function mailchimp:list-member-info($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $email_address as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-member-activity($apikey as xs:string, $id as xs:string, $email_address as element(array)) as item()* {
...
(:~
 ...
 : @return Array of data and success/error counts
 :)
declare %an:sequential function mailchimp:list-member-activity($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $email_address as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-abuse-reports($apikey as xs:string, $id as xs:string, $start as xs:integer, $limit as xs:integer, $since as xs:string) as item()* {
...
(:~
 ...
 : @return The total of all reports and the specific reports reports this page
 :)
declare %an:sequential function mailchimp:list-abuse-reports($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string, $start as xs:integer, $limit as xs:integer, $since as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-growth-history($apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 : @return Array of months and growth
 :)
declare %an:sequential function mailchimp:list-growth-history($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-activity($apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-activity($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-locations($apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 : @return Array of locations
 :)
declare %an:sequential function mailchimp:list-locations($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:list-clients($apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 : @return Array the desktop and mobile user agents in use on the list
 :)
declare %an:sequential function mailchimp:list-clients($endpoint-url as xs:string, $apikey as xs:string, $id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:templates($apikey as xs:string, $types as element(array), $category as xs:string, $inactives as element(array)) as item()* {
...
(:~
 ...
 : @return An array of structs, one for each template (see Returned Fields for details)
 :)
declare %an:sequential function mailchimp:templates($endpoint-url as xs:string, $apikey as xs:string, $types as element(array), $category as xs:string, $inactives as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:template-info($apikey as xs:string, $tid as xs:integer, $type as xs:string) as item()* {
...
(:~
 ...
 : @return An array of info to be used when editing
 :)
declare %an:sequential function mailchimp:template-info($endpoint-url as xs:string, $apikey as xs:string, $tid as xs:integer, $type as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:template-add($apikey as xs:string, $name as xs:string, $html as xs:string) as item()* {
...
(:~
 ...
 : @return The new template id, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:template-add($endpoint-url as xs:string, $apikey as xs:string, $name as xs:string, $html as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:template-update($apikey as xs:string, $id as xs:integer, $values as element(array)) as item()* {
...
(:~
 ...
 : @return True if the template was updated, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:template-update($endpoint-url as xs:string, $apikey as xs:string, $id as xs:integer, $values as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:template-del($apikey as xs:string, $id as xs:integer) as item()* {
...
(:~
 ...
 : @return True if the template was deleted, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:template-del($endpoint-url as xs:string, $apikey as xs:string, $id as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:template-undel($apikey as xs:string, $id as xs:integer) as item()* {
...
(:~
 ...
 : @return boolean true if the template was deleted, otherwise an error will be thrown
 :)
declare %an:sequential function mailchimp:template-undel($endpoint-url as xs:string, $apikey as xs:string, $id as xs:integer) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:get-account-details($apikey as xs:string) as item()* {
...
(:~
 ...
 : @return Array containing the details for the account tied to this API Key
 :)
declare %an:sequential function mailchimp:get-account-details($endpoint-url as xs:string, $apikey as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:generate-text($apikey as xs:string, $type as xs:string, $content as item()) as item()* {
...
(:~
 ...
 : @return The content pass in converted to text.
 :)
declare %an:sequential function mailchimp:generate-text($endpoint-url as xs:string, $apikey as xs:string, $type as xs:string, $content as item()) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:inline-css($apikey as xs:string, $html as xs:string, $strip_css as xs:boolean) as item()* {
...
(:~
 ...
 : @return Your HTML content with all CSS inlined, just like if we sent it.
 :)
declare %an:sequential function mailchimp:inline-css($endpoint-url as xs:string, $apikey as xs:string, $html as xs:string, $strip_css as xs:boolean) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:folders($apikey as xs:string, $type as xs:string) as item()* {
...
(:~
 ...
 : @return Array of folder structs (see Returned Fields for details)
 :)
declare %an:sequential function mailchimp:folders($endpoint-url as xs:string, $apikey as xs:string, $type as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:folder-add($apikey as xs:string, $name as xs:string, $type as xs:string) as item()* {
...
(:~
 ...
 : @return The folder_id of the newly created folder.
 :)
declare %an:sequential function mailchimp:folder-add($endpoint-url as xs:string, $apikey as xs:string, $name as xs:string, $type as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:folder-update($apikey as xs:string, $fid as xs:integer, $name as xs:string, $type as xs:string) as item()* {
...
(:~
 ...
 : @return True if the update worked, otherwise an exception is thrown
 :)
declare %an:sequential function mailchimp:folder-update($endpoint-url as xs:string, $apikey as xs:string, $fid as xs:integer, $name as xs:string, $type as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:folder-del($apikey as xs:string, $fid as xs:integer, $type as xs:string) as item()* {
...
(:~
 ...
 : @return True if the delete worked, otherwise an exception is thrown
 :)
declare %an:sequential function mailchimp:folder-del($endpoint-url as xs:string, $apikey as xs:string, $fid as xs:integer, $type as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:ecomm-orders($apikey as xs:string, $start as xs:integer, $limit as xs:integer, $since as xs:string) as item()* {
...
(:~
 ...
 : @return Array the total matching orders and the specific orders for the requested page
 :)
declare %an:sequential function mailchimp:ecomm-orders($endpoint-url as xs:string, $apikey as xs:string, $start as xs:integer, $limit as xs:integer, $since as xs:string) as item()* {
...
(:~
 ...
 : @return True if the data is saved, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:ecomm-order-add($apikey as xs:string, $order as element(array)) as item()* {
...
(:~
 ...
 : @return True if the data is saved, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:ecomm-order-add($endpoint-url as xs:string, $apikey as xs:string, $order as element(array)) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:ecomm-order-del($apikey as xs:string, $store_id as xs:string, $order_id as xs:string) as item()* {
...
(:~
 ...
 : @return True if an order is deleted, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:ecomm-order-del($endpoint-url as xs:string, $apikey as xs:string, $store_id as xs:string, $order_id as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:lists-for-email($apikey as xs:string, $email_address as xs:string) as item()* {
...
(:~
 ...
 : @return An array of list_ids the member is subscribed to.
 :)
declare %an:sequential function mailchimp:lists-for-email($endpoint-url as xs:string, $apikey as xs:string, $email_address as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:campaigns-for-email($apikey as xs:string, $email_address as xs:string) as item()* {
...
(:~
 ...
 : @return An array of campaign_ids the member received
 :)
declare %an:sequential function mailchimp:campaigns-for-email($endpoint-url as xs:string, $apikey as xs:string, $email_address as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:chimp-chatter($apikey as xs:string) as item()* {
...
(:~
 ...
 : @return An array of chatter messages and properties
 :)
declare %an:sequential function mailchimp:chimp-chatter($endpoint-url as xs:string, $apikey as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:apikeys($username as xs:string, $password as xs:string, $apikey as xs:string, $expired as xs:boolean) as item()* {
...
(:~
 ...
 : @return An array of API keys.
 :)
declare %an:sequential function mailchimp:apikeys($endpoint-url as xs:string, $username as xs:string, $password as xs:string, $apikey as xs:string, $expired as xs:boolean) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:apikey-add($username as xs:string, $password as xs:string, $apikey as xs:string) as item()* {
...
(:~
 ...
 : @return A new API Key that can be immediately used.
 :)
declare %an:sequential function mailchimp:apikey-add($endpoint-url as xs:string, $username as xs:string, $password as xs:string, $apikey as xs:string) as item()* {
...
(:~
 ...
 : @return True if it worked, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:apikey-expire($username as xs:string, $password as xs:string, $apikey as xs:string) as item()* {
...
(:~
 ...
 : @return True if it worked, otherwise an error is thrown.
 :)
declare %an:sequential function mailchimp:apikey-expire($endpoint-url as xs:string, $username as xs:string, $password as xs:string, $apikey as xs:string) as item()* {
...
(:~
 ...
 :)
declare %an:sequential function mailchimp:ping($apikey as xs:string) as item()* {
...
(:~
 ...
 : @return Returns "Everything's Chimpy!" if everything is chimpy, otherwise returns an error message
 :)
declare %an:sequential function mailchimp:ping($endpoint-url as xs:string, $apikey as xs:string) as item()* {
