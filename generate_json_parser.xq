...
variable $filename := "JSON.ebnf";
variable $output   := "json/JSONParser.js";
variable $grammar := fs:read-text("json/" || $filename);
...
<http:request href="http://www.bottlecaps.de/rex/" method="POST" override-media-type="text/plain">
  <http:multipart media-type="multipart/form-data">
     ...
     <http:body media-type="text/plain">-tree -javascript -a xqlint</http:body>
  </http:multipart>
</http:request>
});
