exports.XQLint = function (file, source, sctx) {
    'use strict';
    ...
    var StyleCheck = require('./formatter/style_check').StyleCheck;
    ...
    var styleChecker = new StyleCheck(source);
    markers = markers.concat(styleChecker.getMarkers());
